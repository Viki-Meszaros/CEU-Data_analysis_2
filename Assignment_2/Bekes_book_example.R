...
share <- read.csv("c://Users/admin/Documents/CEU/Fall_semester/Coding_1/R_codes/Class_10/data/clean/share-health.csv")
...
# save temp file
write.csv(share, "c://Users/admin/Documents/CEU/Fall_semester/Coding_1/R_codes/Class_10/data/clean/share-health-fin.csv", row.names = F)
